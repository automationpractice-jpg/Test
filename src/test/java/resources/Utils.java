...
public class Utils {
		...
		public RequestSpecification placeAPIReqSpecification() throws IOException
		{
			if(reqSpec == null)
			{
		...
		public ResponseSpecification placeAPIRespSpecification()
		{
		...
		public static String getGlobalValue(String key) throws IOException
		{
			...
			FileInputStream fis = new FileInputStream("E:\\Automation\\REST API Automation\\APIAutomation\\APIAutomationFramework\\src\\test\\java\\resources\\global.properties");
			prop.load(fis);
